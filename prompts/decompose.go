...
// decompose.go (spec L4030: prompts/decompose.go - task decomposition
// prompt).
//
...
// PromptTemplate (spec L4030: decompose.go - task decomposition).
...
// reflection (spec L4030: decompose.go).
...
// PromptTemplate (spec L4030: decompose.go).
