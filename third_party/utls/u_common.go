...
import (
	...
	"github.com/Christopher-Schulze/Artemis/third_party/utls/internal/helper"
	...
	for _, extType := range tlsExtensionTypes {
		...
		if extension == nil || !ok {
			...
			case utlsExtensionApplicationSettings:
				// upstream-note: tlsfingerprint.io should record/provide application settings data
...
// based on spec's GreaseStyle, GREASE_RESERVED may be replaced by another GREASE value
// https://tools.ietf.org/html/draft-ietf-tls-grease-01
const GREASE_RESERVED = 0x0a0a
