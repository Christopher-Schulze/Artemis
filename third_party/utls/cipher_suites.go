...
import (
	...
	"github.com/Christopher-Schulze/Artemis/third_party/utls/internal/boring"
...
// of the ID value if the cipher suite is not provided by this package.
...
var cipherSuites = []*cipherSuite{ // upstream-note: replace with a map, since the order doesn't matter.
...
var cipherSuitesTLS13 = []*cipherSuiteTLS13{ // upstream-note: replace with a map.
