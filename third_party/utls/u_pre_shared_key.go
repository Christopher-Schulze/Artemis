...
//
//     > - Implementations should marshal the extension into bytes, using reserved binders to maintain the correct length.
//
...
func (e *UtlsPreSharedKeyExtension) PatchBuiltHello(hello *PubClientHelloMsg) error {
	...
	private.pskBinders = e.Binders // set the reserved value to the private Hello
...
// type ExternalPreSharedKeyExtension struct{} // upstream-note: wait for whoever cares about external PSK to implement it
