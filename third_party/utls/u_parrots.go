	...
	case HelloChrome_58, HelloChrome_62:
		return ClientHelloSpec{
			...
			Extensions: []TLSExtension{
				...
				&SupportedCurvesExtension{[]CurveID{CurveID(GREASE_RESERVED),
		...
		return ClientHelloSpec{
			...
			Extensions: []TLSExtension{
				...
				&KeyShareExtension{[]KeyShare{
					{Group: CurveID(GREASE_RESERVED), Data: []byte{0}},
					{Group: X25519},
				}},
...
func generateRandomizedSpec(
	...
	if p.TLSVersMax == VersionTLS13 {
		...
		// upstream-note: randomly add DelegatedCredentialsExtension, once it is
