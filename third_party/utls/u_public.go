...
type PubClientHelloMsg struct {
	...
	cachedPrivateHello   *clientHelloMsg // upstream-note: further optimize to reduce clientHelloMsg construction
...
func MakeClientSessionState(
	...
	// upstream-note: Add EMS to this constructor in uTLS v2
